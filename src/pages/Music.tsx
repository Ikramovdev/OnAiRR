...
const Music = () => {
  ...
  useEffect(() => {
    Instance.get(`3/discover/movie?include_adult=false&include_video=false&language=en-US&page=1&sort_by=popularity.desc`, {
      headers: {
    ...
    <div>
      ...
      <div className='MovieBody'>
        <div className='max-w-[1400px] mx-auto py-20'>
          <h3 className='font-regular text-[24px] lg:text-[32px] text-white mb-[32px]'>Filtered special films</h3>
          <div className='overflow-x-auto'>
            <div className='overflow-x-auto py-4'>
              <div className='flex items-center gap-5 lg:gap-8 w-max lg:px-4'>
